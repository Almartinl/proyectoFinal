...
export default function Contact() {
  ...
  return (
    ...
    >
      <Grid container spacing={1} height="100vh" p={10}>
        <Grid container item xs={4} bgcolor="darkgreen" boxShadow="10px">
        ...
        <Grid item xs={8} py={20} border="4px solid darkgreen ">
      ...
      <Grid container justifyContent="center" marginTop={4} gap={4}>
